...
include vendor/oppo/OP4E9F/BoardConfigVendor.mk
...
TARGET_KERNEL_CONFIG := sm7250-perf_defconfig
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 243447836672
...
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 10406068224 # (BOARD_SUPER_PARTITION_SIZE - 4194304) 4MiB overhead
BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions
BOARD_SUPER_PARTITION_SIZE := 10410262528
BOARD_CACHEIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_ODMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
